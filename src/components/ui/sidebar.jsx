...
// You can follow the same pattern for all remaining components (SidebarGroupAction, SidebarGroupContent, SidebarMenu, SidebarMenuButton, etc.)
// just remove all TypeScript types and keep the logic intact.
