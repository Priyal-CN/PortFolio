...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen hero-background relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="text-white animate-slide-in-left">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-xl leading-relaxed">
              ...
              cutting-edge web development to advanced AI systems, we deliver
          ...
          <div className="relative animate-slide-in-right">
            ...
            {/* Floating Elements */}
            <div
              className="absolute -top-6 -right-6 glass p-4 rounded-xl animate-fade-in"
            ...
            <div
              className="absolute -bottom-6 -left-6 glass p-4 rounded-xl animate-fade-in"
